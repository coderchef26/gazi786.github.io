...
export default async function ProjectPage({ params }: Props) {
	...
	try {
		...
		const fallbackProject =
			fallbackProjects[slug as keyof typeof fallbackProjects];
            ...
            `,
				...
				<Container maxWidth="lg" className="relative z-10 py-12">
					<div className="mb-8">
						<Link
							href="/#projects"
							className="inline-flex items-center text-cyan-400 hover:text-cyan-300 transition-colors arc-reactor-btn"
						>
						...
						<div className="lg:col-span-2 space-y-8">
							<Card>
								<div className="relative overflow-hidden">
									...
									<div className="absolute top-4 left-4">
										<Chip
											label={fallbackProject.category}
							...
							<Card>
								<CardContent className="p-8">
									<Typography
										variant="h5"
										className="font-semibold mb-6 text-gray-900 dark:text-white"
									>
										Project Details
									</Typography>
