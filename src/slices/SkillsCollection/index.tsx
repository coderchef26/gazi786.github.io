...
/**
 * Props for `SkillsCollection`.
 */
export type SkillsCollectionProps =
  SliceComponentProps<Content.SkillsCollectionSlice>;

interface SkillCollectionItem {
  skill_name?: string;
 ...
 */
const SkillsCollection: FC<SkillsCollectionProps> = ({ slice }) => {
