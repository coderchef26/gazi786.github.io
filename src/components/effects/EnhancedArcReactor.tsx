...
export default function EnhancedArcReactor({ 
  ...
  const glowColor = powerLevel > 80 ? '#00d4ff' : powerLevel > 50 ? '#00a8cc' : '#006680';
  ...
  return (
    ...
    >
      ...
      {/* Power beams */}
      {showPowerBeams && isActive && energyPulses.map((pulse, index) => (
        <motion.div
          key={pulse}
      ...
      <div className="absolute -bottom-8 left-1/2 -translate-x-1/2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-cyan-400 jarvis-text">{powerLevel}%</span>
        </div>
      </div>
