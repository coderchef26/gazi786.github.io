...
export default function AtlasNavigator() {
  ...
  const ActiveComponent = navigationItems.find(item => item.id === activeView)?.component || Hero;
      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 z-[50] w-64">
        <div className="bg-gradient-to-br from-[#1a1a2e]/90 to-[#16213e]/90 backdrop-blur-sm border border-[#00d4ff]/30 rounded-lg p-6">
          <div className="flex items-center mb-6">
            <EnhancedArcReactor size="sm" powerLevel={100} className="scale-75 mr-3" />
            <div>
              <h2 className="text-lg font-bold stark-text text-[#00d4ff]">ATLAS</h2>
            ...
            >
              <div className="h-full overflow-y-auto overflow-x-hidden">
                <div className="min-h-full p-8">
                  <ActiveComponent slice={mockSliceData} index={0} slices={[mockSliceData]} context={{}} />
                </div>
              </div>
            </motion.div>
          )}
          ...
          {isTransitioning && (
            ...
            >
              <div className="text-center">
                ...
                <p className="stark-text text-cyan-400">ATLAS TRANSITIONING...</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
